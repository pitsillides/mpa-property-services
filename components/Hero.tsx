            ...
            <div className="space-y-4 max-w-xl">
              ...
              <p className="text-sm sm:text-base text-slate-200/85">
                {pick(lang, {
                  ...
                  ru: "Мы занимаемся общими расходами, оплатами, обслуживанием, заявками на ремонт и ежедневной связью с комитетами, владельцами и жильцами.",
                })}
              </p>
            </div>
            ...
            <div className="text-sm text-slate-200/85 max-w-sm">
              {lang === "gr" ? (
                ...
                <p>
                  ...
                  помогая держать процессы понятными, а реакцию быстрой.
                </p>
              ) : (
                <p>
